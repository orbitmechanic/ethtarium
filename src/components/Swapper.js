...
// baoswap: '0x6093AeBAC87d62b1A5a4cEec91204e35020E38bE'
...
let defaultToken = 'ETH' //Add xdai different
let defaultTokenOut = 'DAI'
// let defaulTokens = {main:'ETH', xdai:'XDAI'}
// let defaultTokensOut = {main:'DAI', xdai:'WETH'}
...
function Swap({ selectedProvider, tokenListURI }) {
  ...
  let inputIsToken = tokenIn !== 'ETH' //Check for xdai
  ...
  const cleanIpfsURI = (uri) => { //not necessary after dictionary
    try {
