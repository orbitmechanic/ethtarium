  ...
  return (
    <div className="App">
      ...
      <BrowserRouter>
        <Route exact path="/">
          ...
          <Grid className='App-header'  container spacing={3}>
            ...
            <Grid item xs={6}>
              ...
              <p>It was needed a new ways to see it.</p>
            ...
            <Grid item xs={12} >
              ...
              <SearchIcon />
                  <InputBase
                    ...
                    />
              <Button onClick={()=>selectGraphEndpoint(document.getElementById('search').value)} style={{backgroundColor:'grey',color:'white',fontWeight:'bold'}}>Go!</Button><br /><br />
              <Link to='/Add'>
            ...
            <ul>
              ...
              <li>Decide over the purpose and whereabouts of planethary!</li>
            </ul>

            </Grid>
            <Grid item xs={4}><h3>As developers</h3>
            <ul>
              <li>Insert planethary on your web!</li>
              <li>Explore and create new ways to interact within web3 with our (open repo?) system</li>
        ...
        <Route path='/Add'>
          Create a form to convert inputs into DB mode to cut+paste quickly
        </Route>
      </BrowserRouter>
      </body>
      </div>
